...
CREATE TABLE Products(
	...
	ImageURL VARCHAR(1000) DEFAULT 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/No_image_available.svg/480px-No_image_available.svg.png',
);
...
--SELECT StoreID, SUM(ProductQuantity) from STORES INNER JOIN STORE_INVENTORY on STORES.ID = STORE_INVENTORY.StoreID INNER JOIN Products ON STORE_INVENTORY.ProductID = ProductID GROUP BY StoreID;
 ...
 VALUES('DAMION','SILVER','damion.silver@gmail.com','password', 'Admin');
